module.exports = {
  images: {
    domains: ['Yutadev-media.s3.amazonaws.com'],
  },
  async rewrites() {
    return [
      {
      ...
      {
        source: '/masterclass',
        destination: 'https://assets.Yuta.dev/masterclass',
      },
      {
    ...
    return [
      {
        ...
        destination:
          'https://Yuta.notion.site/Masterclass-Build-a-SM-app-in-2-days-a531dd6e786c491692e1f24c965538ad',
        permanent: false,
      },
      {
        source: '/shop',
      ...
      {
        source: '/hack',
        destination: '/blog/2022-11-03-Yuta-Hack',
        permanent: true,
      },
    ];
  },
