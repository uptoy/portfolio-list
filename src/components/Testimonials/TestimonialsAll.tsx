...
const Testimonials = () => (
  <MaxWidthWrapper>
    <section className="flex flex-col items-center my-5">
      ...
      <div className="p-5">
        <VideoPlayer
          url="https://Yutadev-media.s3.amazonaws.com/testimonials/videos/Course+Testimonial+Compilation+Long.mp4"
          autoplay={true}
        />
      ...
      <div className="grid grid-cols-2 gap-5">
        <TestimonialCard
          ...
          videoUrl={
            'https://Yutadev-media.s3.amazonaws.com/testimonials/videos/4.+Luigi+Piscitelli+Testimonial.mp4'
          }
        ...
        <TestimonialCard
          ...
          videoUrl={
            'https://Yutadev-media.s3.amazonaws.com/testimonials/videos/2.+Veloshan+Pillay+Testimonial.mp4'
          }
        ...
        <TestimonialCard
          ...
          image={rogelio}
          href=""
          quote="If you truly have a passion for mobile development, if you truly want to learn and take your skills to the next level, you have to invest in yourself. Yuta.dev provides quality content and help you every step of the way."
          videoUrl={
            'https://Yutadev-media.s3.amazonaws.com/testimonials/videos/5.+Rogelio+Zamora+Testimonial.mp4'
          }
        ...
        <TestimonialCard
          ...
          videoUrl={
            'https://Yutadev-media.s3.amazonaws.com/testimonials/videos/3.+Andrew+Day+Testimonial.mp4'
          }
        ...
        <TestimonialCard
          ...
          videoUrl={
            'https://Yutadev-media.s3.amazonaws.com/testimonials/videos/Testimonial+Petr+Brantalik.mp4'
          }
        />
        ...
        <TestimonialCard
          ...
          Testimonial={() => (
            <>
              ...
              <b>Yuta.dev</b> team for being an incredible resource
      ...
      <h2 className="mt-20 mb-10 text-4xl">Yuta.dev on Social media</h2>
      <div className="flex">
        <div>
          <Image
            src={screenshot1}
